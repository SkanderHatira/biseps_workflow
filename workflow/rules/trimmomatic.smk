rule trimmomatic_pe:
	input:
		unpack(get_raw)
	output:
		r1="results/{sample}-TechRep_{techrep}-BioRep_{biorep}/trimmed/{sample}-1.fq",
		r1_unpaired="results/{sample}-TechRep_{techrep}-BioRep_{biorep}/trimmed/{sample}-1.unpaired.fq",
		r2="results/{sample}-TechRep_{techrep}-BioRep_{biorep}/trimmed/{sample}-2.fq",
		r2_unpaired="results/{sample}-TechRep_{techrep}-BioRep_{biorep}/trimmed/{sample}-2.unpaired.fq",
	conda:
